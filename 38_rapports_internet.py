...
log = setup_logging("38_rapports_internet")
...
def export_cache_to_jsonl():
    ...
    jsonl_file = os.path.join(OUTPUT_DIR, "rapports_internet_cache.jsonl")
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Script 38 — Rapports Définitifs Internet")
    ...
    if args.export:
        log.info("=" * 60)
        log.info("SCRIPT 38 — Export cache → JSONL (--export)")
        log.info("=" * 60)
