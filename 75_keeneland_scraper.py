...
def main():
    ...
    if args.mode in ("sales", "all"):
        ...
        for year in range(args.year_start, year_end + 1):
            for sale_code in SALE_CODES:
                ...
                save_checkpoint(CHECKPOINT_FILE, {"last_sale_key": sale_key, "total_records": total_records})
                smart_pause(3.0, 1.5)
    ...
    save_checkpoint(CHECKPOINT_FILE, {"total_records": total_records, "status": "done"})
