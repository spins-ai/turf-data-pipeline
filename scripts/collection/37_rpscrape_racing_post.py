...
_HEADERS = {"Accept": "text/html,application/xhtml+xml", "Accept-Language": "en-GB,en;q=0.9", "DNT": "1"}
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Script 37 — Racing Post Results (FR courses)")
