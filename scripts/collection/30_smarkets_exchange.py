...
def export_cache_to_jsonl():
    ...
    jsonl_file = os.path.join(OUTPUT_DIR, "smarkets_exchange_cache.jsonl")
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Script 30 — Smarkets Exchange Cotes")
    ...
    if args.export:
        log.info("=" * 60)
        log.info("SCRIPT 30 — Export cache → JSONL (--export)")
        log.info("=" * 60)
