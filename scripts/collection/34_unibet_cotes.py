...
log = setup_logging("34_unibet_cotes")
...
def export_cache_to_jsonl():
    ...
    jsonl_file = os.path.join(OUTPUT_DIR, "unibet_cotes_cache.jsonl")
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Script 34 — Unibet FR Cotes Hippiques")
    ...
    if args.export:
        log.info("=" * 60)
        log.info("SCRIPT 34 — Export cache → JSONL (--export)")
        log.info("=" * 60)
