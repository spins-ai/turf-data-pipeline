...
def export_cache_to_jsonl():
    ...
    jsonl_file = os.path.join(OUTPUT_DIR, "reunions_enrichies_cache.jsonl")
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Script 39 — Reunions enrichies")
    ...
    if args.export:
        log.info("=" * 60)
        log.info("SCRIPT 39 — Export cache → JSONL (--export)")
        log.info("=" * 60)
