...
def export_cache_to_jsonl():
    ...
    jsonl_file = os.path.join(OUTPUT_DIR, "turfomania_cache.jsonl")
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Script 32 — Turfomania Indices & Pronostics")
    ...
    if args.export:
        log.info("=" * 60)
        log.info("SCRIPT 32 — Export cache → JSONL (--export)")
        log.info("=" * 60)
