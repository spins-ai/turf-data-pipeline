...
log = setup_logging("31_zone_turf")
...
def export_cache_to_jsonl():
    ...
    jsonl_file = os.path.join(OUTPUT_DIR, "zone_turf_cache.jsonl")
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Script 31 — Zone-Turf Pronostics & Stats")
    ...
    if args.export:
        log.info("=" * 60)
        log.info("SCRIPT 31 — Export cache → JSONL (--export)")
        log.info("=" * 60)
