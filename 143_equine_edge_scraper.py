...
def extract_race_links(soup):
    """Extract links to individual race or horse form pages."""
    links = set()
    for a in soup.find_all("a", href=True):
        href = a["href"]
        if re.search(r'/(form-guide|results?|horse|race|card)/', href, re.I):
...
def extract_runners_table(soup, date_str, race_url=""):
    """Extract runner data from form guide or results tables."""
    records = []
...
def extract_data_attributes(soup, date_str):
    ...
    records = []
    keywords = ["horse", "runner", "jockey", "trainer", "form", "rating",
                "result", "position", "odds", "pattern", "stats"]
